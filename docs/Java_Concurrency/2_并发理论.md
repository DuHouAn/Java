...
![img](../_pics/pics/concurrent/d2a12961-2b36-4463-b017-ca46a3308b8e.png)

JMM 规定所有的变量都存储在主内存中，每个线程还有自己的工作内存，**工作内存存储在高速缓存或者寄存器**中，保存了该线程使用的**变量的主内存副本拷贝**。

**线程只能直接操作工作内存中的变量，不同线程之间的变量值传递需要通过主内存来完成**。

![img](../_pics/pics/concurrent/8162aebb-8fd2-4620-b771-e65751ba7e41.png)
...
![img](../_pics/pics/concurrent/b6a7e8af-91bf-44b2-8874-ccc6d9d52afc.jpg)
...
![img](../_pics/pics/concurrent/847b9ba1-b3cd-4e52-aa72-dee0222ae09f.jpg)

AtomicInteger 能保证多个线程修改的原子性。

![img](../_pics/pics/concurrent/3144015c-dcfb-47ac-94a5-bab3b78b0f14.jpg)
...
![img](../_pics/pics/concurrent/94414cd3-5db9-4aca-a2af-539140955c62.jpg)

#### 规则二：管程锁定规则

一个 unlock 操作先行发生于后面对同一个锁的 lock 操作。

![img](../_pics/pics/concurrent/de9d8133-4c98-4e07-b39c-302e162784ea.jpg)
...
![img](../_pics/pics/concurrent/5e6e05d6-1028-4f5c-b9bd-1a40b90d6070.jpg)
...
![img](../_pics/pics/concurrent/bc5826f5-014d-47b4-9a76-d86b80968643.jpg)
...
![img](../_pics/pics/concurrent/54e6d499-80df-488e-aa7e-081766c41538.jpg)
